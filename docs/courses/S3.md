...
Lecture content can be accessed via [WUR's learning environment](https://brightspace.wur.nl/). Participants have been emailed login details (search 'wur.nl Servicedesk IT').
